...
const _kPurplePrimaryValue = 0xFF223A7C;
 const kAccentColorLight = MaterialColor(
  _kPurplePrimaryValue,
  <int, Color>{
    900: Color.fromARGB(255, 11, 31, 83),
    800: Color(0xFF223A7C),
    700: Color(0xFF223A7C),
    600: Color(0xFF223A7C),
    500: Color(_kPurplePrimaryValue),
    400: Color(0xFF223A7C),
    300: Color(0xFF223A7C),
    200: Color(0xFF223A7C),
    100: Color(0xFF223A7C),
    50: Color.fromARGB(255, 81, 100, 153),
  },
);
